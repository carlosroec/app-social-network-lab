<template>
    <div class="bg-white border-t border-b sm:border-l sm:border-r sm:rounded shadow mb-6 py-4 px-4">
        <div v-if="mode === 'add' || mode === 'edit'">
            <textarea class="shadow appearance-none border rounded w-full h-32"></textarea>
            ...
            <div class="shadow bg-white">
                ...
                <div class="p-4">
                    <p class="text-grey-dark leading-tight">
                        ...
                        Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculusmus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.
                    </p>
                    <div class="mt-4 flex justify-end">
                        <a href="#" class="no-underline mr-4 text-green hover:text-green-light">edit</a>
