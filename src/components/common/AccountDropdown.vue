<template>
  <div class="relative">
    ...
    <div v-if="isOpen" class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-lg shadow-xl">
      <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-blue-300 hover:text-white">Configuración</a>
      <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-blue-300 hover:text-white" @click="logout">Salir</a>
    </div>
  </div>
</template>
